    ...
    <footer className="footer">
      <div className="container footer-inner">
        ...
        <div className="footer-links">
          ...
          <a href="https://www.linkedin.com/in/faeyza-ardellein-yaradhitya-053a0b431/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
            <i className="fa-brands fa-linkedin-in" />
          </a>
          <a href="mailto:fardellein@gmail.com" aria-label="Email">
